...
namespace MoreGuns
{
    public class GunConfiguration
    {
        ...
        private void InitializePreferences(string ID, WeaponBase weapon)
        {
            ...
            MinAimFOVReduction = Category.CreateEntry($"{ID} Min Aim FOV Reduction", gunEquippable.MinAimFOVReduction);
            MaxAimFOVReduction = Category.CreateEntry($"{ID} Max Aim FOV Reduction", gunEquippable.MaxAimFOVReduction);
