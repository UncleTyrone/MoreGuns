"""Dump SniperRifle_5 islands — has deep hangs at y≈-0.58."""
...
SRC = r"D:\Schedule I\Schedule I\MoreGuns\UnityAuthoring\Assets\Models\_downloads\extracted\quaternius\Ultimate Gun Pack - July 2019\OBJ\SniperRifle_5.obj"
...
def main():
    ...
    for g in sorted(groups, key=lambda x: -len(x)):
        ...
        print(
            f"isl n={len(g):3d} "
            f"x=[{xmin:7.3f},{xmax:7.3f}] y=[{ymin:7.3f},{ymax:7.3f}] zW={zmax-zmin:.3f} "
